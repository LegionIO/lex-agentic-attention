...
RSpec.describe Legion::Extensions::Agentic::Attention::Prism::Runners::CognitivePrism do
  ...
  describe '#create_beam' do
    ...
    it 'returns failure on ArgumentError (MAX_BEAMS)' do
      stub_const('Legion::Extensions::Agentic::Attention::Prism::Helpers::Constants::MAX_BEAMS', 0)
