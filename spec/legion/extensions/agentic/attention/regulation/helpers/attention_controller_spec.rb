...
RSpec.describe Legion::Extensions::Agentic::Attention::Regulation::Helpers::AttentionController do
  ...
  describe '#add_target' do
    it 'adds a target and returns it' do
      ...
      expect(target).to be_a(Legion::Extensions::Agentic::Attention::Regulation::Helpers::AttentionTarget)
