...
RSpec.describe Legion::Extensions::Agentic::Attention::Regulation::Client do
  ...
  it 'accepts an injected controller' do
    ctrl = Legion::Extensions::Agentic::Attention::Regulation::Helpers::AttentionController.new
