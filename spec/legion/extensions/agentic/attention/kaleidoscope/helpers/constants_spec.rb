...
RSpec.describe Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Constants do
  described_class = Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Constants
