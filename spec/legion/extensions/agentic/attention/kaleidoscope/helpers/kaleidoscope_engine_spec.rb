...
RSpec.describe Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::KaleidoscopeEngine do
  ...
  describe '#create_facet' do
    it 'creates and stores a facet' do
      ...
      expect(f).to be_a(Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Facet)
      expect(engine.all_facets.size).to eq(1)
    end

    it 'raises when limit reached' do
      stub_const('Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Constants::MAX_FACETS', 2)
  ...
  describe '#create_pattern' do
    it 'creates and stores a pattern' do
      ...
      expect(p).to be_a(Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Pattern)
    ...
    it 'raises when limit reached' do
      stub_const('Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::Constants::MAX_PATTERNS', 1)
