...
RSpec.describe Legion::Extensions::Agentic::Attention::Kaleidoscope::Runners::CognitiveKaleidoscope do
  let(:runner) do
    obj = Object.new
  ...
  let(:engine) { Legion::Extensions::Agentic::Attention::Kaleidoscope::Helpers::KaleidoscopeEngine.new }
