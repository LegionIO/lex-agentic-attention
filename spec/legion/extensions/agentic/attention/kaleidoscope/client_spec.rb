...
RSpec.describe Legion::Extensions::Agentic::Attention::Kaleidoscope::Client do
  subject(:client) { described_class.new }

  it 'includes the runner module' do
    expect(described_class.ancestors).to include(
      Legion::Extensions::Agentic::Attention::Kaleidoscope::Runners::CognitiveKaleidoscope
    )
  end
