...
RSpec.describe Legion::Extensions::Agentic::Attention::Focus::Helpers::Habituation do
  ...
  describe '#record' do
    ...
    it 'caps at HABITUATION_CEILING' do
      ceiling = Legion::Extensions::Agentic::Attention::Focus::Helpers::Constants::HABITUATION_CEILING
