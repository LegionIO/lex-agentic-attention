...
RSpec.describe Legion::Extensions::Agentic::Attention::Focus::Helpers::FocusManager do
  ...
  describe '#focus_on' do
    ...
    it 'returns :capacity_full when max is reached' do
      Legion::Extensions::Agentic::Attention::Focus::Helpers::Constants::MAX_MANUAL_FOCUS.times do |i|
  ...
  describe '#focus_boost' do
    it 'returns FOCUS_BOOST for focused domains' do
      ...
      expect(manager.focus_boost(:terraform)).to eq(
        Legion::Extensions::Agentic::Attention::Focus::Helpers::Constants::FOCUS_BOOST
      )
    end
