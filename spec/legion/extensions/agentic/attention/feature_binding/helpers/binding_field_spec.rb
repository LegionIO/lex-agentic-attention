...
RSpec.describe Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::BindingField do
  subject(:field) { described_class.new }

  let(:constants) { Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::Constants }
  ...
  describe '#register_feature' do
    it 'adds a feature' do
      ...
      expect(f).to be_a(Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::Feature)
  ...
  describe '#bind' do
    it 'creates a bound object from feature ids' do
      ...
      expect(obj).to be_a(Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::BoundObject)
