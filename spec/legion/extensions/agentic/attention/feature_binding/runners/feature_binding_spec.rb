...
RSpec.describe Legion::Extensions::Agentic::Attention::FeatureBinding::Runners::FeatureBinding do
  let(:field) { Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::BindingField.new }
  let(:host) do
    obj = Object.new
  ...
  describe '#register_feature' do
    ...
    it 'returns failure at limit' do
      Legion::Extensions::Agentic::Attention::FeatureBinding::Helpers::Constants::MAX_FEATURES.times do |i|
