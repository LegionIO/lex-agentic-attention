...
RSpec.describe Legion::Extensions::Agentic::Attention::Blindspot::Helpers::BlindspotEngine do
  ...
  describe '#set_boundary' do
    it 'creates a new boundary' do
      ...
      expect(b).to be_a(Legion::Extensions::Agentic::Attention::Blindspot::Helpers::KnowledgeBoundary)
    end
