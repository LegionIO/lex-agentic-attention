...
RSpec.describe Legion::Extensions::Agentic::Attention::Synesthesia::Runners::CognitiveSynesthesia do
  let(:client) { Legion::Extensions::Agentic::Attention::Synesthesia::Client.new }
