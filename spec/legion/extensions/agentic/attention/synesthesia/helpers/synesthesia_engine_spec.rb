...
RSpec.describe Legion::Extensions::Agentic::Attention::Synesthesia::Helpers::SynesthesiaEngine do
  ...
  describe '#dominant_modality_pairs' do
    ...
    it 'respects the limit' do
      5.times do |i|
        mods = Legion::Extensions::Agentic::Attention::Synesthesia::Helpers::Constants::MODALITIES
        src  = mods[i]
        tgt  = mods[i + 1]
