...
RSpec.describe Legion::Extensions::Agentic::Attention::SignalDetection::Runners::SignalDetection do
  let(:client) { Legion::Extensions::Agentic::Attention::SignalDetection::Client.new }
