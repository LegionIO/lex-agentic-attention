...
RSpec.describe Legion::Extensions::Agentic::Attention::Subliminal::Runners::Subliminal do
  let(:engine) { Legion::Extensions::Agentic::Attention::Subliminal::Helpers::SubliminalEngine.new }
  let(:runner) do
    obj = Object.new
