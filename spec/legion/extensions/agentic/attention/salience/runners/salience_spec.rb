...
RSpec.describe Legion::Extensions::Agentic::Attention::Salience::Runners::Salience do
  subject(:client) { Legion::Extensions::Agentic::Attention::Salience::Client.new }
  ...
  describe '#compute_salience' do
    context 'with empty tick_results' do
      ...
      it 'returns :background urgency for zero signals' do
        ...
        expect(Legion::Extensions::Agentic::Attention::Salience::Helpers::Constants::URGENCY_LEVELS).to include(result[:urgency])
      end
