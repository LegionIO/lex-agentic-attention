...
RSpec.describe Legion::Extensions::Agentic::Attention::Salience::Helpers::SalienceMap do
  subject(:map) { described_class.new }

  let(:low_signals) do
    Legion::Extensions::Agentic::Attention::Salience::Helpers::SignalIntegrator.integrate(tick_results: {})
  end

  let(:high_signals) do
    Legion::Extensions::Agentic::Attention::Salience::Helpers::SignalIntegrator.integrate(
      tick_results: {
        emotion:     { arousal: 1.0 },
