...
RSpec.describe Legion::Extensions::Agentic::Attention::Schema::Client do
  subject(:client) { described_class.new }

  it 'includes Runners::AttentionSchema' do
    expect(described_class.ancestors).to include(Legion::Extensions::Agentic::Attention::Schema::Runners::AttentionSchema)
  end
