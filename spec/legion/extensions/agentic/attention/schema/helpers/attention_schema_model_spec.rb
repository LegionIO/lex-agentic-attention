...
RSpec.describe Legion::Extensions::Agentic::Attention::Schema::Helpers::AttentionSchemaModel do
  subject(:model) { described_class.new }

  let(:constants) { Legion::Extensions::Agentic::Attention::Schema::Helpers::Constants }
