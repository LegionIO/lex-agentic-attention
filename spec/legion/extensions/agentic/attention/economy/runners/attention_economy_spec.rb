...
require 'legion/extensions/agentic/attention/economy/client'

RSpec.describe Legion::Extensions::Agentic::Attention::Economy::Runners::AttentionEconomy do
  let(:client) { Legion::Extensions::Agentic::Attention::Economy::Client.new }
