...
RSpec.describe Legion::Extensions::Agentic::Attention::Economy::Helpers::AttentionBudget do
  ...
  describe '#create_demand' do
    it 'returns a Demand object' do
      demand = add_demand
      expect(demand).to be_a(Legion::Extensions::Agentic::Attention::Economy::Helpers::Demand)
    end
    ...
    it 'raises ArgumentError when max demands reached' do
      stub_const('Legion::Extensions::Agentic::Attention::Economy::Helpers::Constants::MAX_DEMANDS', 1)
