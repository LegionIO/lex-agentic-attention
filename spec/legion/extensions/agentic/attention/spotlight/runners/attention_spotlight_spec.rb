...
require 'legion/extensions/agentic/attention/spotlight/client'

RSpec.describe Legion::Extensions::Agentic::Attention::Spotlight::Runners::AttentionSpotlight do
  let(:client) { Legion::Extensions::Agentic::Attention::Spotlight::Client.new }
