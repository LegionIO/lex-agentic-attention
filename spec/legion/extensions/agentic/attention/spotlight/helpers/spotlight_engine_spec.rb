...
RSpec.describe Legion::Extensions::Agentic::Attention::Spotlight::Helpers::SpotlightEngine do
  ...
  describe '#initialize' do
    ...
    it 'starts with a Spotlight instance' do
      expect(engine.spotlight).to be_a(Legion::Extensions::Agentic::Attention::Spotlight::Helpers::Spotlight)
    end
  ...
  describe '#register_target' do
    ...
    it 'respects MAX_TARGETS limit' do
      stub_const('Legion::Extensions::Agentic::Attention::Spotlight::Helpers::Constants::MAX_TARGETS', 2)
      register(label: 'a')
      register(label: 'b')
  ...
  describe '#check_peripheral' do
    ...
    it 'respects MAX_PERIPHERAL limit' do
      stub_const('Legion::Extensions::Agentic::Attention::Spotlight::Helpers::Constants::MAX_PERIPHERAL', 2)
