...
RSpec.describe Legion::Extensions::Agentic::Attention::Spotlight::Client do
  ...
  it 'accepts an injected engine' do
    engine = Legion::Extensions::Agentic::Attention::Spotlight::Helpers::SpotlightEngine.new
