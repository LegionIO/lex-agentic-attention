...
RSpec.describe Legion::Extensions::Agentic::Attention::Arousal::Runners::Arousal do
  let(:client) { Legion::Extensions::Agentic::Attention::Arousal::Client.new }
  ...
  describe '#stimulate' do
    ...
    it 'increases arousal above default' do
      ...
      expect(result[:arousal]).to be > Legion::Extensions::Agentic::Attention::Arousal::Helpers::Constants::DEFAULT_AROUSAL
    end
  end
