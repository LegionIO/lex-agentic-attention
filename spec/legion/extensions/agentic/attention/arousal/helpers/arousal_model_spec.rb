...
RSpec.describe Legion::Extensions::Agentic::Attention::Arousal::Helpers::ArousalModel do
  let(:model) { described_class.new }

  describe '#initialize' do
    it 'starts at the default arousal level' do
      expect(model.arousal).to be_within(0.001).of(Legion::Extensions::Agentic::Attention::Arousal::Helpers::Constants::DEFAULT_AROUSAL)
    end
  ...
  describe '#optimal_for' do
    it 'returns the correct optimal for each complexity' do
      constants = Legion::Extensions::Agentic::Attention::Arousal::Helpers::Constants
    ...
    it 'returns the default when complexity is unknown' do
      expect(model.optimal_for(:unknown)).to eq(Legion::Extensions::Agentic::Attention::Arousal::Helpers::Constants::OPTIMAL_AROUSAL_DEFAULT)
    end
  end

  describe '#arousal_history cap' do
    it 'does not exceed MAX_AROUSAL_HISTORY entries' do
      max = Legion::Extensions::Agentic::Attention::Arousal::Helpers::Constants::MAX_AROUSAL_HISTORY
