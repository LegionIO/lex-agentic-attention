...
RSpec.describe Legion::Extensions::Agentic::Attention::Blink::Helpers::BlinkEngine do
  ...
  describe '#submit_stimulus' do
    it 'returns a processed Stimulus' do
      ...
      expect(result).to be_a(Legion::Extensions::Agentic::Attention::Blink::Helpers::Stimulus)
