...
RSpec.describe Legion::Extensions::Agentic::Attention::Blink::Helpers::Constants do
  let(:klass) { Class.new { include Legion::Extensions::Agentic::Attention::Blink::Helpers::Constants } }
