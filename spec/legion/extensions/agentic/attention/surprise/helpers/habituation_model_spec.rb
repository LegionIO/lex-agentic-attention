...
RSpec.describe Legion::Extensions::Agentic::Attention::Surprise::Helpers::HabituationModel do
  subject(:model) { described_class.new }

  let(:floor) { Legion::Extensions::Agentic::Attention::Surprise::Helpers::Constants::DOMAIN_HABITUATION_FLOOR }
  let(:habituation_rate) { Legion::Extensions::Agentic::Attention::Surprise::Helpers::Constants::HABITUATION_RATE }
  let(:sensitization_rate) { Legion::Extensions::Agentic::Attention::Surprise::Helpers::Constants::SENSITIZATION_RATE }
  ...
  describe 'domain limit enforcement' do
    it 'does not exceed MAX_DOMAINS tracked domains' do
      max = Legion::Extensions::Agentic::Attention::Surprise::Helpers::Constants::MAX_DOMAINS
